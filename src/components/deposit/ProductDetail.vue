      ...
      <div class="detail">
        ...
        <div>
          ...
          <table v-if="isDataLoaded === true">
            ...
            <tr>
              <td>기본(%)</td>
              <td v-for="(month, index) in months" :key="'b-' + index"
                  v-text="productRate['basic_rate'][month] == null ? '-' : productRate['basic_rate'][month]">
              </td>
            </tr>
            <tr>
              <td>우대(%)</td>
              <td v-for="(month, index) in months" :key="'p-' + index"
                  v-text="productRate['prime_rate'][month] == null ? '-' : productRate['prime_rate'][month]">
              </td>
            </tr>
          </table>
          <br>
...
export default {
  ...
  created () {
    ...
    if (params['productId'] === undefined) {
      ...
      this.$http.get('/fss/deposit_products/' + params['productId'], {
        params: {
